...
#> 1 1.071209  41.87357 0.9999955   2.3651 5.027294     7     5.027294    22.00811    1.437502       20.5706   11.7228
#>   hours_above_mesor_ext up_mesor_ext down_mesor_ext up_mesor_deriv_ext  rss_ext    tss_y F_pseudo_ext    R2_ext mesor_cos phi_cos
#> 1                   7.6     1.227294       8.827294           4.122847 367111.7 918030.4     836.9371 0.6001094  8.303093 5.03083
#>    amp_cos  rss_cos   R2_cos niter info                                                 message
#> 1 9.859391 428104.2 0.533671    42    1 Relative error in the sum of squares is at most `ftol'.
```
...
#>               <dbl> <dbl> <dbl> <dbl>
#>  1           0.0167 16.0   10.8  7.22
#>  2           0.0333  5.72  10.9  7.27
#>  3           0.05    5.09  10.9  7.33
#>  4           0.0667  5.90  10.9  7.38
#>  5           0.0833  7.70  11.0  7.43
#>  6           0.1    10.3   11.0  7.49
#>  7           0.117   9.81  11.1  7.54
#>  8           0.133   8.32  11.1  7.60
#>  9           0.15    4.71  11.2  7.65
#> 10           0.167   4.19  11.2  7.70
#> # ℹ 10,070 more rows
```
...
#> 1 1.071209  41.87357 0.9999955   2.3651 5.027294
```
...
#> 1     5.027294    22.00811    1.437502       20.5706   11.7228                   7.6     1.227294       8.827294           4.122847
#>   F_pseudo_ext    R2_ext
#> 1     836.9371 0.6001094
```
...
#> 1 1.071201 41.8738     1 2.365092 5.027295 836.9373 5.027295  5.027295 22.0081     7
```
...
#> 1       20.5706    19.71878     5.027294 5.03083   11.7228  8.303093
```
...
`R2_ext` tells us that 60% of the variation in the epoch level data can
be predicted by the extended cosinor fit. `R2_cos` tells us that 53.4%
